...
namespace MountainRoutes.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstAscent = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MountainRoutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MountainRoutes_Mountains_MountainId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Huts_MountainRoutes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "MountainRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Huts_RouteId",
                table: "Huts",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_MountainRoutes_MountainId",
                table: "MountainRoutes",
                column: "MountainId");
        }
